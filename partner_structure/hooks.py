...
def post_init_hook(cr, registry):
    ...
    _logger.info(_("Preparing datas for 'partner_structure'..."))
    ...
    if tools.config.get("demo_booking"):
        _logger.info(_("Loading demo datas for 'partner_structure'..."))
        ...
        image_folder = "./odoo/external-src/crm-booking/partner_structure/static/img/"
        image_files = {}
        ...
        for name, img_path in image_files.items():
            with open(img_path, "rb") as image_file:
                partner = env.ref("partner_structure.{}".format(name))
